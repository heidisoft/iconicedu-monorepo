...
const BASE_MESSAGE_SELECT = `
  ...
  sender:profiles!sender_profile_id(id, display_name, first_name, last_name, avatar_url, avatar_seed, kind, timezone)
`;
  ...
  private async loadThreads(
    ...
    const [
      ...
      supabase
        ...
        .select(
          'thread_id, profile:profiles!profile_id(id, display_name, first_name, last_name, avatar_url, avatar_seed, kind, timezone)',
        )
