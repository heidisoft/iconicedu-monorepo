        ...
        notificationDeliveryJobs: [
          {
            ...
            dedupe_key:
              'notification.deliver:event-1:profile-guardian-1:push:2026-04-01T10',
            payload: {
              recipientProfileId: 'profile-guardian-1',
              prefKey: 'messages.mentions',
              deliveryChannel: 'push',
              deliveryTiming: 'immediate',
              attemptBucket: '2026-04-01T10',
            },
            priority: 80,
          ...
          },
          {
            ...
            source_kind: 'activity_event',
            dedupe_key:
              'notification.deliver:event-2:profile-child-1:email:2026-04-02T09',
            payload: {
              recipientProfileId: 'profile-child-1',
              prefKey: 'sessions.reminders',
              deliveryChannel: 'email',
              deliveryTiming: 'immediate',
              attemptBucket: '2026-04-02T09',
            },
            priority: 80,
    ...
    const dashboard = buildAdminReportsDashboardVM(
      {
        ...
        notificationDeliveryJobs: [] as never,
        liveSessions: [
          {
            id: 'session-1',
            org_id: 'org-1',
