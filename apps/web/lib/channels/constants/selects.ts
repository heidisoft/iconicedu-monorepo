...
export const CHANNEL_READ_STATE_SELECT =
  'id, org_id, channel_id, thread_id, account_id, last_read_message_id, last_read_at, unread_count, manually_marked_unread, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by';
