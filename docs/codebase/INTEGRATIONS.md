...
| Supabase Realtime                 | WebSocket                 | Live message updates (mobile)                                                                       | RLS-scoped channel subscription                                              | Medium                            | `docs/codebase/ARCHITECTURE.md` (Realtime section)                                                                                    |
| Supabase Storage                  | File storage              | Message attachments, avatars, thumbnails                                                            | Bucket RLS policies                                                          | Medium                            | `docs/codebase/ARCHITECTURE.md` (Storage section)                                                                                     |
