...
| `@marsidev/react-turnstile` / `react-native-webview`         | `^1.6.1` / `^13.16.1`                       | Cloudflare Turnstile widget for Supabase Attack Protection on auth OTP (web / mobile). See [operations/turnstile.md](../operations/turnstile.md) | `apps/web/package.json`, `apps/mobile/package.json`                                         |
