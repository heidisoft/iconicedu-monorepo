...
| `@tanstack/react-query`                                      | `^5.90.11`                                  | Client data fetching/cache (actively used in mobile; present but unused in web — see [CONCERNS.md](CONCERNS.md)) | `apps/mobile/package.json`, `apps/web/package.json`                                         |
