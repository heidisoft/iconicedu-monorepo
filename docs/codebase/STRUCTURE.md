...
| `packages/ui-web` / `packages/ui-native` | Reusable, portable UI components (no app routing/context deps)                                                 | Business logic, direct API calls                                                        | `docs/architecture/packages.md`                                  |
| `packages/utils`                         | Pure, side-effect-free, framework-neutral helpers                                                              | React/RN/Next-specific code                                                             | `docs/architecture/packages.md`                                  |
