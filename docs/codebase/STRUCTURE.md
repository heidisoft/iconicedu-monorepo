...
| `packages/shared-types/`    | Cross-app TypeScript contracts: `rows/`, `vm/`, `payloads/`, and `shared/`; reserved contract ownership is documented in `domain/`, `mappers/`, `projections/`, and `validators/` | `packages/shared-types/src/`                                |
...
| `packages/utils/`           | Framework-neutral executable utilities, including shared contract conversions                                                                                                     | `packages/utils/src/`                                       |
...
| `packages/shared-types`                  | Cross-app rows, VMs, payloads, enums, and other data contracts                                                 | Executable helpers, app-specific logic, I/O, authorization, or orchestration            | `packages/shared-types/src/`                                     |
...
| `packages/utils`                         | Pure, side-effect-free, framework-neutral helpers and contract conversions                                     | React/RN/Next-specific code, authorization, or app-specific policy                      | `packages/utils/src/`                                            |
