...
| `packages/shared-types/`    | Cross-app TypeScript contracts: `rows/`, `vm/`, `payloads/`, `shared/`, plus pure `mappers/`; reserved contracts are documented in `domain/`, `projections/`, and `validators/` | `packages/shared-types/src/`                                |
...
| `packages/shared-types`                  | Cross-app rows, VMs, payloads, enums, and pure contract mappers                                                | App-specific or framework-specific logic, I/O, authorization, or orchestration          | `packages/shared-types/src/`                                     |
