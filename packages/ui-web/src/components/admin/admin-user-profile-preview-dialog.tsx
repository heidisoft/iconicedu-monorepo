...
function TabPanel({
  ...
  value: AdminUserPreviewTab;
  children: React.ReactNode;
}) {
  return (
    <TabsContent
      value={value}
      data-testid={`scroll-shell-${value}`}
      className="m-0 min-h-0 flex-1 overflow-y-auto overscroll-contain pt-4 pr-4"
    >
      {children}
    </TabsContent>
  );
...
export function AdminUserProfilePreviewDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] flex-col overflow-hidden border border-border/70 shadow-2xl dark:border-border sm:max-w-4xl">
        <DialogHeader>
        ...
        {isLoading ? (
          ...
          <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden">
            ...
            >
              ...
              <TabPanel value="student-profile">
                <div className="space-y-4">
                  {profile?.kind === 'child' ? (
                    <FieldGrid
                      items={[
              ...
              <TabPanel value="educator-profile">
                <div className="space-y-4">
              ...
              <TabPanel value="educator-availability">
                <div className="space-y-4">
