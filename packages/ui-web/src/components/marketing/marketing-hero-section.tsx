      ...
      <div className="relative z-10 mx-auto max-w-6xl pt-20">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground">
            Warm, affordable online tutoring from experienced USA and global tutors. We
            cover the full K-12 curriculum, align support to state standards where
            applicable, and give advanced learners the stretch they need.
          </p>
