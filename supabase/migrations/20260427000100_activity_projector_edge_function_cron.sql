...
comment on function public.configure_edge_function_cron(text) is
  'Schedules Supabase edge functions for reminders, activity source jobs, activity projection retries, notifications, and maintenance jobs. The activity-projector-dispatch edge function must call apps/api /internal/activity-feed/project via ACTIVITY_PROJECTOR_DISPATCH_URL and INTERNAL_ACTIVITY_PROJECTOR_TOKEN.';
